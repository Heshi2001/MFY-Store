...
urlpatterns = [
    ...
    path("account/addresses/set-default-shipping/<int:pk>/", views.set_default_shipping, name="set_default_shipping"),
    path("account/addresses/set-default-billing/<int:pk>/", views.set_default_billing,  name="set_default_billing"),
    ...
    path("orders/<int:order_id>/return/",   views.request_return_view, name="request_return"),
    path("returns/<int:return_id>/",        views.return_detail_view,  name="return_detail"),
    path("returns/<int:return_id>/approve/",  views.approve_return_view,  name="approve_return"),
    path("returns/<int:return_id>/complete/", views.complete_return_view, name="complete_return"),
    ...
    path('track-accordion/', views.track_accordion_open, name='track_accordion'),
    path("buy-again/", views.buy_again, name="buy_again"),
    path("search-history/", views.search_history_page, name="search_history"),
    path("brand/<slug:slug>/", views.brand_detail, name="brand_detail"),
    path("webhooks/aftership/", views.aftership_webhook, name="aftership_webhook"),
